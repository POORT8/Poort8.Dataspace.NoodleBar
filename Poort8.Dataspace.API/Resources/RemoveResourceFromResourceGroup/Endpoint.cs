...
namespace Poort8.Dataspace.API.Resources.RemoveResourceFromResourceGroup;
...
public class Endpoint : EndpointWithoutRequest
{
    ...
    public const string EndpointSummary = "Remove a resource from a resource group";
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        await _authorizationRegistry.RemoveResourceFromResourceGroup(resourceGroupId, resourceId);
